...
CREATE POLICY "Users can view all insurance applications" ON insurance_applications
    FOR SELECT USING (true);

CREATE POLICY "Users can insert insurance applications" ON insurance_applications
    FOR INSERT WITH CHECK (true);

CREATE POLICY "Users can update insurance applications" ON insurance_applications
    FOR UPDATE USING (true);

CREATE POLICY "Users can delete insurance applications" ON insurance_applications
