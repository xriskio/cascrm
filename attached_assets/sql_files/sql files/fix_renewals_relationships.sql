...
ALTER TABLE renewal_status_history ENABLE ROW LEVEL SECURITY;
...
DROP POLICY IF EXISTS "Enable all operations for renewal_status_history" ON renewal_status_history;
CREATE POLICY "Enable all operations for renewal_status_history" ON renewal_status_history FOR ALL USING (true);
