...
CREATE POLICY "Users can view renewal status history" ON renewal_status_history
  FOR SELECT USING (true);

CREATE POLICY "Users can insert renewal status history" ON renewal_status_history
