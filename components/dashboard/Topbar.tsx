      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid ${notifHover ? BDM : BD}`,
            background: notifHover ? BG2 : 'transparent',
            cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
            position: 'relative', transition: 'background 0.12s', color: T2,
          }}
        ...
        >
          ...
          <span style={{ position: 'absolute', top: 7, right: 7, width: 7, height: 7, borderRadius: '50%', background: '#EF4444', border: `1.5px solid ${BG1}` }} />
        </button>
