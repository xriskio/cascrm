  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ fontSize: 14, fontWeight: 600, letterSpacing: '-0.3px', color: TEXT }}>
          Dashboard
        </div>
      ...
      <div ref={searchRef} style={{ flex: 1, maxWidth: 420, position: 'relative' }}>
        <div
          style={{
            ...
            gap: 7,
            background: BG2,
            border: `1px solid ${searchOpen ? BLUE_BD : BDM}`,
            borderRadius: 8,
            padding: '0 11px',
            height: 32,
            cursor: 'text',
        ...
        <SearchResults
          query={searchQ}
          open={searchOpen && searchQ.length > 1}
          onClose={() => {
            setSearchOpen(false)
            setSearchQ('')
          }}
        ...
        <div ref={copilotRef} style={{ position: 'relative' }}>
          <div
            ...
            style={{
              ...
              padding: '5px 12px',
              borderRadius: 20,
              background: copilotOpen ? 'rgba(59,130,246,0.20)' : BLUE_BG,
                ...
                {QUICK.map((a) => (
                  <Link key={a.href} href={a.href} onClick={() => setCopilotOpen(false)} style={{ textDecoration: 'none' }}>
                    <div
                      ...
                      onMouseEnter={(e) => {
                        ;(e.currentTarget as HTMLDivElement).style.borderColor = BLUE_BD
                      }}
                      onMouseLeave={(e) => {
                        ;(e.currentTarget as HTMLDivElement).style.borderColor = BD
                      }}
                    >
                      {a.label}
                    </div>
