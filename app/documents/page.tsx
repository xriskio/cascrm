      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <select className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50">
              ...
              <button className="p-2 bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-lg hover:shadow-md transition-all duration-200">
                <Filter className="h-4 w-4 text-gray-600" />
              </button>
              <div className="flex bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-lg p-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="group bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="font-semibold text-gray-800 mb-1">Policy Documents</h3>
            <p className="text-sm text-gray-600">Insurance policies and related documents</p>
          </div>
          ...
          <div className="group bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="font-semibold text-gray-800 mb-1">Client Files</h3>
            <p className="text-sm text-gray-600">Client applications and submissions</p>
          </div>
          ...
          <div className="group bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="font-semibold text-gray-800 mb-1">Certificates</h3>
            <p className="text-sm text-gray-600">Insurance certificates and endorsements</p>
          </div>
          ...
          <div className="group bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <p className="text-sm text-gray-600">Analytics and compliance reports</p>
          </div>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl shadow-lg">
          ...
          <div className="p-16 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">No documents found</h3>
              ...
              <div className="flex gap-3">
                ...
                <button className="bg-white/70 backdrop-blur-sm border border-gray-200/50 text-gray-700 px-6 py-3 rounded-lg hover:shadow-md transition-all duration-200">
                  Learn More
                </button>
              </div>
            </div>
