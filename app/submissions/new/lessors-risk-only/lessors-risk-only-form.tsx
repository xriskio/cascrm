...
export default function LessorsRiskOnlyForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      formData.append("insuranceType", "lessors-risk-only")
      ...
      console.error("Error submitting lessors risk only form:", err)
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 space-y-6 max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold">Lessors Risk Only Submission</h1>
      ...
      <fieldset className="space-y-4 border p-4 rounded-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="frontExposure" className="block text-sm font-medium">
              Front Exposure & Distance
            </label>
            <input id="frontExposure" name="frontExposure" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="rearExposure" className="block text-sm font-medium">
              Rear Exposure & Distance
            </label>
            <input id="rearExposure" name="rearExposure" className="w-full p-2 border rounded" />
          </div>
        </div>

        <h3 className="font-medium mt-6">Alarm and Sprinkler Systems</h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="burglarAlarmType" className="block text-sm font-medium">
              Burglar Alarm Type
            </label>
            <input id="burglarAlarmType" name="burglarAlarmType" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="certificateNumber" className="block text-sm font-medium">
              Certificate Number
            </label>
            <input id="certificateNumber" name="certificateNumber" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="expirationDate" className="block text-sm font-medium">
              Expiration Date
            </label>
            <input id="expirationDate" name="expirationDate" type="date" className="w-full p-2 border rounded" />
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex items-center space-x-4">
            <span className="text-sm font-medium">Alarm Information</span>
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="centralStation" name="alarmInfo" value="Central Station" />
              <label htmlFor="centralStation">Central Station</label>
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <input type="checkbox" id="localGong" name="alarmInfo" value="Local Gong" />
            <label htmlFor="localGong">Local Gong</label>
          </div>
          <div className="flex items-center space-x-2">
            <input type="checkbox" id="withKeys" name="alarmInfo" value="With Keys" />
            <label htmlFor="withKeys">With Keys</label>
          </div>
        </div>

        <div>
          <label htmlFor="alarmInstalledBy" className="block text-sm font-medium">
            Burglar Alarm Installed and Serviced By
          </label>
          <input id="alarmInstalledBy" name="alarmInstalledBy" className="w-full p-2 border rounded" />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="alarmExtent" className="block text-sm font-medium">
              Alarm Extent
            </label>
            <input id="alarmExtent" name="alarmExtent" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="alarmGrade" className="block text-sm font-medium">
              Alarm Grade
            </label>
            <select id="alarmGrade" name="alarmGrade" className="w-full p-2 border rounded">
              <option value="">Please choose</option>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="numGuards" className="block text-sm font-medium">
              # Guards/ Watchmen
            </label>
            <input id="numGuards" name="numGuards" type="number" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="guardRounds" className="block text-sm font-medium">
              Guard/Watchman Rounds
            </label>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="clockHourly" name="guardRounds" value="Clock Hourly" />
                <label htmlFor="clockHourly">Clock Hourly</label>
              </div>
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="guardRoundsOther" name="guardRounds" value="Other" />
                <label htmlFor="guardRoundsOther">Other</label>
              </div>
            </div>
          </div>
        </div>

        <h3 className="font-medium mt-4">Premises Fire Protection (Sprinklers, Standpipes, CO2 / Chemical Systems)</h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="percentSprinklered" className="block text-sm font-medium">
              % Sprinklered
            </label>
            <input id="percentSprinklered" name="percentSprinklered" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="fireAlarmManufacturer" className="block text-sm font-medium">
              Fire Alarm Manufacturer
            </label>
            <input id="fireAlarmManufacturer" name="fireAlarmManufacturer" className="w-full p-2 border rounded" />
          </div>
          <div>
            <label htmlFor="alarmSoundsAt" className="block text-sm font-medium">
              Alarm Sounds at
            </label>
            <select id="alarmSoundsAt" name="alarmSoundsAt" className="w-full p-2 border rounded">
              <option value="">Please choose</option>
      ...
      {/* Property: Additional Interests */}
      <fieldset className="space-y-4 border p-4 rounded-md">
        <legend className="font-semibold text-lg">Property: Additional Interests</legend>

        <p className="text-sm mb-4">
          The ADDITIONAL INTEREST information will not be included into your policy and must be communicated to your
          underwriter to be applied.
        </p>

        <h3 className="font-medium">Commercial Property Additional Interests</h3>
          ...
          <table className="min-w-full border">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border p-2 text-left">Additional Interest Type</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border p-2">
                  <input name="additionalInterestLoc" className="w-full p-1 border rounded" />
                </td>
                <td className="border p-2">
                  <input name="additionalInterestBldg" className="w-full p-1 border rounded" />
                </td>
                <td className="border p-2">
                  <input name="additionalInterestName" className="w-full p-1 border rounded" />
                </td>
                <td className="border p-2">
                  <select name="additionalInterestType" className="w-full p-1 border rounded">
                    ...
                    <option value="Lender's Loss Payable">Lender's Loss Payable</option>
                  </select>
                </td>
              </tr>
            </tbody>
        ...
        <div>
          <label htmlFor="additionalInterestRemarks" className="block text-sm font-medium">
            Remarks
          </label>
          <textarea
            id="additionalInterestRemarks"
            name="additionalInterestRemarks"
            rows={3}
            className="w-full p-2 border rounded"
          ></textarea>
        </div>
      ...
      <div className="flex justify-between">
        ...
        >
          {isSubmitting ? "Submitting..." : "Submit Lessors Risk Only"}
        </button>
      </div>
    </form>
  )
