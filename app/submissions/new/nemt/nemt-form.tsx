      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-lg shadow-md">
        ...
        {currentStep === 1 && (
          <div className="p-6">
            ...
            <p className="text-muted-foreground mb-6">Basic information about your NEMT business</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div>
                <label htmlFor="medicaidProvider" className="block text-sm font-medium text-muted-foreground mb-1">
              ...
              <div>
                <label htmlFor="nemtLicense" className="block text-sm font-medium text-muted-foreground mb-1">
                  NEMT License Number
                </label>
                <input
                  type="text"
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-border rounded"
                />
                <label htmlFor="professionalLiability" className="ml-2 block text-sm text-muted-foreground">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-border rounded"
                />
                <label htmlFor="generalLiability" className="ml-2 block text-sm text-muted-foreground">
                  General Liability
                </label>
              </div>
            </div>
                  ...
                  <tbody className="bg-card divide-y divide-border">
                    {claims.map((claim, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">${claim.amount}</td>
                        <td className="px-6 py-4 text-sm text-muted-foreground">{claim.description}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{claim.status}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="border border-border rounded-md p-4 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <label htmlFor="claimAmount" className="block text-sm font-medium text-muted-foreground mb-1">
                    Amount
                  </label>
                  <input
                    type="number"
              ...
              <div className="mb-4">
                <label htmlFor="claimDescription" className="block text-sm font-medium text-muted-foreground mb-1">
                  Description
                </label>
                <textarea
                  id="claimDescription"
              ...
              <div className="mb-4">
                <label htmlFor="claimStatus" className="block text-sm font-medium text-muted-foreground mb-1">
                  Status
                </label>
                <select
                  id="claimStatus"
        ...
        {currentStep === 3 && (
          <div className="p-6">
            ...
            <div className="mb-6">
              <label htmlFor="serviceTypes" className="block text-sm font-medium text-muted-foreground mb-1">
            ...
            <div className="mt-6 mb-6">
              <label htmlFor="clientTypes" className="block text-sm font-medium text-muted-foreground mb-1">
            ...
            <div className="mb-6">
              <label htmlFor="contractedFacilities" className="block text-sm font-medium text-muted-foreground mb-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-border rounded"
                />
                <label htmlFor="driverTraining" className="ml-2 block text-sm text-muted-foreground">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-border rounded"
                />
                <label htmlFor="patientHandlingTraining" className="ml-2 block text-sm text-muted-foreground">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-border rounded"
                />
                <label htmlFor="backgroundChecks" className="ml-2 block text-sm text-muted-foreground">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-border rounded"
                />
                <label htmlFor="drugTesting" className="ml-2 block text-sm text-muted-foreground">
            ...
            <div className="mb-6">
              <label htmlFor="safetyProgram" className="block text-sm font-medium text-muted-foreground mb-1">
          ...
          <div className="p-6">
            ...
            <div className="border border-border rounded-md p-4 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  <label htmlFor="wheelchairCapacity" className="block text-sm font-medium text-muted-foreground mb-1">
                    Wheelchair Capacity
                  </label>
                  <input
                    type="number"
                ...
                <div>
                  <label htmlFor="stretcherCapacity" className="block text-sm font-medium text-muted-foreground mb-1">
                    Stretcher Capacity
                  </label>
                  <input
                    type="number"
            ...
            <div className="border border-border rounded-md p-4 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  <label htmlFor="nemtCertified" className="block text-sm font-medium text-muted-foreground mb-1">
                    NEMT Certified
                  </label>
                  <input
                    type="checkbox"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  <label htmlFor="cprCertified" className="block text-sm font-medium text-muted-foreground mb-1">
                    CPR Certified
                  </label>
                  <input
                    type="checkbox"
