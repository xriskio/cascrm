    ...
    <div className="p-6">
      ...
      <div className="bg-card rounded-md shadow p-6">
        ...
        <div className="mt-6 p-4 bg-muted rounded">
          ...
          <code className="block whitespace-pre-wrap bg-muted p-3 rounded text-sm">
            {`CREATE TABLE users (
  id UUID PRIMARY KEY,
  email TEXT,
  name TEXT,
  ...
  updated_at TIMESTAMP WITH TIME ZONE
        ...
        <div className="mt-6">
          <p className="text-sm text-muted-foreground">
            ...
            <code className="block mt-1 p-2 bg-muted rounded">/supabase/migrations/recreate_users_table.sql</code>
          </p>
        </div>
      </div>
    </div>
