    ...
    <div className="p-6">
      ...
      {isLoading ? (
        <div className="bg-card border border-border rounded-md p-8 text-center">
          <p className="text-muted-foreground">Loading submission contacts...</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-md p-8 text-center">
          <p className="text-muted-foreground">No submission contacts found. Add contacts using the button above.</p>
        </div>
      )}
    </div>
  )
