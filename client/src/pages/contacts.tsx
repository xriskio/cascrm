        ...
        <div className="flex items-start justify-between">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <Link to={`/contacts/${contact.id}/policies`}>View Policies</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link to={`/contacts/${contact.id}/files`}>View Files</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link to={`/contacts/${contact.id}/account`}>Account Info</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
