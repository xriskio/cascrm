...
import { getRenewal, updateRenewalStatus, archiveRenewal } from "@/lib/actions/renewal-actions"
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {existingWorkflowId ? (
            <Button
              onClick={() => navigate(`/renewal-workflow/${existingWorkflowId}`)}
              variant="outline"
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (res.ok || res.status === 409) {
                    ...
                    navigate(`/renewal-workflow/${wfId}`)
                  } else {
