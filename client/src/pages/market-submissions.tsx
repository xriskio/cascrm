  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      >
        ...
        >
          <Link to="/market-submissions/new" className="flex items-center gap-2">
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <Button asChild variant="outline" size="sm">
                      <Link to={`/market-submissions/view/${submission.id}`}>View Details</Link>
                    </Button>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <Card className="bg-white/70 backdrop-blur-sm border border-gray-200/50">
              <CardContent className="p-16 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <Button asChild>
                    <Link to="/market-submissions/new">
