...
export const QQ_CONFIG = {
  CLIENT_ID: process.env.QQ_CLIENT_ID || process.env.NEXT_PUBLIC_QQ_CLIENT_ID || "fdc3c5d6-4bd4-40c0-b681-d2ad2f5db414",
  ...
  OAUTH_CLIENT_ID: "fdc3c5d6-4bd4-40c0-b681-d2ad2f5db414",
}
